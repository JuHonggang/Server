...
$socket = stream_socket_server("tcp://192.168.0.56:8888", $errno, $errstr);
...
function ev_accept($socket, $flag, $base)
{
	...
	event_buffer_enable($buffer, EV_READD | EV_PERSIST);
...
function ev_error($buffer, $error, $id)
{
	...
	unset($GLOBALS['buffer'][$id], $GLOBALS['connections'][$id]);
}
